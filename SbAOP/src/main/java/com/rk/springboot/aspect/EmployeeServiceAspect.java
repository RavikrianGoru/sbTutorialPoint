...
public class EmployeeServiceAspect {
	...
	@Before(value = "execution(* com.rk.springboot.service.EmployeeService.*(..)) and args(empId, fname, sname)")
	...
	@After(value = "execution(* com.rk.springboot.service.EmployeeService.*(..)) and args(empId)")
	public void afterAdvice(JoinPoint joinPoint, String empId)
	{
		System.out.println("After method "+joinPoint.getSignature());
		System.out.println("Deleting Employee with emp id -  " + empId);  
	}
